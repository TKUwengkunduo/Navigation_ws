...
if __name__ == "__main__":
    ...
    create_transporter("transporter01", label_to_pos(21), euler_to_quaternion_2d(270))
    create_transporter("transporter02", label_to_pos(1), euler_to_quaternion_2d(90))
    create_transporter("transporter03", [-32.0, -54.0, 0.0], euler_to_quaternion_2d(270))
    create_transporter("transporter04", [-16.33, -14.57, 0.0], euler_to_quaternion_2d(0))
    create_transporter("transporter05", label_to_pos(5), euler_to_quaternion_2d(90))
    create_transporter("transporter06", label_to_pos(6), euler_to_quaternion_2d(270))
    create_transporter("transporter07", label_to_pos(13), euler_to_quaternion_2d(180))
    create_transporter("transporter08", label_to_pos(14), euler_to_quaternion_2d(270))
    create_transporter("transporter09", label_to_pos(16), euler_to_quaternion_2d(270))
