...
import carb
import torch as th
from env import TransporterEnv
...
my_env = TransporterEnv(headless=False)
...
checkpoint_callback = CheckpointCallback(save_freq=10000, save_path=log_dir, name_prefix="./transporter/transporter_policy_checkpoint")
model = PPO(
    policy,
    my_env,
