...
bool navigation_interfaces__msg__robot_targets__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("navigation_interfaces.msg._robot_targets.RobotTargets", full_classname_dest, 53) == 0);
  }
  navigation_interfaces__msg__RobotTargets * ros_message = _ros_message;
  {  // robot_id
...
{
  /* NOTE(esteve): Call constructor of RobotTargets */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("navigation_interfaces.msg._robot_targets");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RobotTargets");
